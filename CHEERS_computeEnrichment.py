...
parser.add_argument("--ld", help = "Directory with LD information for each SNP")
...
'''
open file containing normalized counts per region (*_counts_normToMax_quantileNorm_euclideanNorm.txt). 
